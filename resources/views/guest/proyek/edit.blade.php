        ...
        <form action="{{ url('proyek/'.$dataProyek->proyek_id) }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" name="kode_proyek" value="{{ $dataProyek->kode_proyek }}"
                        class="form-control" required>
                </div>
                <div class="col">
                    <label>Nama Proyek</label>
                    <input type="text" name="nama_proyek" value="{{ $dataProyek->nama_proyek }}"
                        class="form-control" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    <label>Lokasi</label>
                    <input type="text" name="lokasi" value="{{ $dataProyek->lokasi }}" class="form-control"
                        required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" name="anggaran" value="{{ $dataProyek->anggaran }}" class="form-control"
                        required>
                </div>
                <div class="col">
                    <label>Sumber Dana</label>
                    <input type="text" name="sumber_dana" value="{{ $dataProyek->sumber_dana }}"
                        class="form-control">
                </div>
            </div>
